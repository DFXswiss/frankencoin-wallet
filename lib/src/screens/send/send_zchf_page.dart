...
class SendZCHFPage extends BasePage {
  SendZCHFPage(this.sendVM, this.bottomSheetService,
      {super.key, this.initialAddress, this.initialAmount});
  ...
  @override
  Widget body(BuildContext context) => _SendZCHFPageBody(
        sendVM: sendVM,
...
class _SendZCHFPageBody extends StatefulWidget {
  final SendViewModel sendVM;
  final String? initialAddress;
  final String? initialAmount;
  final BottomSheetService bottomSheetService;

  const _SendZCHFPageBody({
  ...
  @override
  State<StatefulWidget> createState() => _SendZCHFPageBodyState();
}

class _SendZCHFPageBodyState extends State<_SendZCHFPageBody> {
      ...
      Padding(
        ...
        child: CupertinoTextField(
          ...
          prefix: const Padding(
              padding: EdgeInsets.all(15), child: Icon(Icons.currency_franc)),
