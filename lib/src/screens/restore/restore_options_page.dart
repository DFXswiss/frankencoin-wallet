    ...
    return Column(
      children: [
        OptionCard(
          ...
          leadingImagePath: "assets/images/crypto/zchf.png",
          action: () => Navigator.of(context).pushNamed(Routes.walletRestore),
        ),
        OptionCard(
          title: S.of(context).restore_wallet_with_seed_qr_option,
          description:
              S.of(context).restore_wallet_with_seed_qr_option_description,
          leadingImagePath: "assets/images/crypto/xchf.png",
